...
const exportToExcel = (data: Contrato[], filename: string = "contratos") => {
  // Preparar los datos para Excel (excluir el id)
  const excelData = data.map(({ id, ...contrato }) => contrato);
...
const exportToPDF = (data: Contrato[], filename: string = "contratos") => {
  ...
  const tableData = data.map(({ id, ...contrato }) => Object.values(contrato));
    ...
    <div className="p-4 text-black min-h-screen">
      ...
      <div className="mb-4 flex flex-col md:flex-row gap-4 items-center">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => exportToExcel(filteredRecords, "contratos")}
          ...
          <button
            onClick={() => exportToPDF(filteredRecords, "contratos")}
